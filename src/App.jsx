...
useEffect(() => {
  ...
  return (
    <div className="font-bevietnam  border-black overflow-hidden">
      ...
      {/* <img src="/bg-tablet-pattern.svg" alt="" srcset="" className='absolute -top-20 left-20 w-full -z-10 overflow-hidden'/> */}
        <h2 className="border-red-500 text-[2.5rem] text-[hsl(228,39%,23%)] font-[500] text-center my-2 ">Bring everyone together to build better products.</h2>
        <p className="text-[hsl(227,12%,61%)] text-justify border-red-600 w-[90%] text-[1rem] my-2 m-auto">Manage makes it simple for software teams to plan day-to-day 
      ...
      <div className="">
        <h3 className=" text-[hsl(228,39%,23%)] font-[700] text-center my-2 text-[1.5rem]">
        What’s different about Manage?
        </h3>
        <p className=" text-[hsl(227,12%,61%)] text-justify border-red-600 w-[90%] text-[1rem] my-2 m-auto">Manage provides all the functionality your team needs, without 
  the complexity. Our software is tailor-made for modern digital 
  product teams.</p>
      </div>
      <div className="border-green-600">
      <div className="flex flex-col my-2">
        <div className="flex items-center bg-[hsl(13,100%,96%)] w-[95%] self-end rounded-s-2xl">
          <div className="p-2 rounded-2xl text-white bg-[#f25f3a] w-[20%] flex items-center justify-center">01</div>
          <h4 className="font-bold p-2 text-[hsl(228,39%,23%)] text-[0.85rem]">Track company-wide progress</h4>
        </div>
        <p className="text-[hsl(227,12%,61%)] text-justify border-red-600 w-[90%] text-[1rem] my-2 m-auto">See how your day-to-day tasks fit into the wider vision. Go from 
  tracking progress at the milestone level all the way done to the 
  smallest of details. Never lose sight of the bigger picture again.</p>
      </div>
      <div className="flex flex-col  my-2">
        <div className="flex items-center bg-[hsl(13,100%,96%)] w-[95%] self-end rounded-s-2xl">
          <div className="p-2 rounded-2xl text-white bg-[hsl(12,88%,59%)] w-[20%] flex items-center justify-center">02</div>
          <h4 className="font-bold p-2 text-[hsl(228,39%,23%)] text-[0.85rem]">Advanced built-in reports</h4>
        </div>
        <p className="text-[hsl(227,12%,61%)] text-justify border-red-600 w-[90%] text-[1rem] my-2 m-auto">Set internal delivery estimates and track progress toward company 
  goals. Our customisable dashboard helps you build out the reports 
  you need to keep key stakeholders informed.</p>
      </div>
      <div className="flex flex-col my-2">
        <div className="flex items-center bg-[hsl(13,100%,96%)] w-[95%] self-end rounded-s-2xl">
          <div className="p-2 rounded-2xl text-white bg-[hsl(12,88%,59%)] w-[20%] flex items-center justify-center">03</div>
          <h4 className="font-bold p-2 text-[hsl(228,39%,23%)] text-[0.85rem]">Everything you need in one place</h4>
        </div>
        <p className="text-[hsl(227,12%,61%)] text-justify border-red-600 w-[90%] text-[1rem] my-2 m-auto">Stop jumping from one service to another to communicate, store files, 
  ...
  productivity solution.</p>
      ...
      <div className="flex flex-col  bg-[#f25f3a]">
        <h1 className="text-4xl text-white font-bold w-[90%] m-auto text-center p-4">Simplify how your team works today.</h1>
        <button className="py-2 px-6 rounded-2xl my-2 m-auto bg-white shadow-[hsl(12,88%,59%)] text-[hsl(12,88%,59%)] self-center font-semibold">Get Started</button>
      </div>
      <div className="flex flex-col border border-black bg-[hsl(233,12%,13%)]">
        <div className=" w-4/5 m-auto  justify-between ">
        ...
        <div className="grid grid-cols-2 p-4 text-white w-4/5 m-auto">
